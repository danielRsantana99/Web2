...
Route::get('/normalflow',function(){
	return view('layouts.normalflow');
});
...
Route::prefix('fornecedores')->group (function (){
	...
	Route::post('/store', [FornecedorController::class, 'store'])->name('fornecedores.show'); 
	Route::get('/show/{id}',[FornecedorController::class, 'show'])->name('fornecedores.edit');
