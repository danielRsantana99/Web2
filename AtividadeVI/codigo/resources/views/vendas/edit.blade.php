...
@section('conteudo')
    <form class="contact_form" action="{{route('venda.update', ['id' => $vendas->id])}}" method="POST">
        @csrf
        @method('PUT')
      <div class="row">
            <div class="col-sm-6 mb-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('idcliente') is-invalid @enderror" type="text" name="idcliente" id="idcliente" required="" placeholder="">
                        @error('idcliente')
